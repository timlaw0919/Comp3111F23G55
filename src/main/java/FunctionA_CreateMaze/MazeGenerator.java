...
//        for (int i = 0; i<4; i++) {
//            if(pointOnGrid(cell.row, cell.col) && !cell.walls[i])
//                numNeighboringZeros++;
//        }
        ...
        return (numNeighboringZeros < 3) && !maze[cell.row][cell.col].visited;
    }
